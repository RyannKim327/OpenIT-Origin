...
export default function Landing() {
  return (
    <div className="h-full overflow-y-scroll snap-y snap-mandatory">
      <section className="relative bg-gradient-to-br from-red-400 via-[#CE2503] to-orange-100 min-h-screen flex items-center justify-start overflow-x-hidden snap-start">
