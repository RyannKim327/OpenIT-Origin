    ...
    <div className="w-full h-ful">
      ...
      <section className="bg-white text-gray-800 py-16 px-6 md:px-20 mb-10 mt-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-20">
            A dedicated team providing real-time earthquake data. Our purpose is
            to empower communities with accurate seismic information to reduce
          ...
          <div className="grid md:grid-cols-2 gap-10 text-left">
            <div className="bg-white shadow-sm rounded-lg p-7">
              ...
              <p className="text-base">
                ...
                to every corner of the globe, helping people stay informed and
            ...
            <div className="bg-white shadow-sm rounded-lg p-7">
              ...
              <p className="text-base">
                ...
                equipped with the tools and knowledge to respond to seismic
      ...
      <section className="bg-[#f9f9f9] text-gray-800 py-16 px-6 md:px-20">
        <div className="max-w-4xl mx-auto mb-10">
          <h2 className="text-5xl font-bold mb-6 mt-10 text-center">
            What We Do
          </h2>
          <p className="text-lg mb-10 text-center">
            Our platform combines cutting-edge technology with comprehensive
            data analysis to provide you with the most accurate earthquake
          ...
          <div className="flex flex-col items-center lg:grid lg:grid-cols-3 gap-40">
            <div className="text-center bg-white rounded-lg p-7 w-80 shadow-md mt-8 hover:scale-110 group-hover:rotate-6 duration-300">
              ...
              <p className="text-base">
                Track earthquakes as they happen with live data feeds from
            ...
            <div className="text-center bg-white rounded-lg p-7 w-80 shadow-md mt-8 hover:scale-110 group-hover:rotate-6 duration-300">
              ...
              <p className="text-base">
                Advanced algorithms process seismic data to provide accurate
            ...
            <div className="text-center bg-white rounded-lg p-7 w-80 shadow-md mt-8  hover:scale-110 group-hover:rotate-6 duration-300">
              ...
              <p className="text-base">
                Receive instant notifications about significant seismic events
        ...
        <div className="max-w-3xl mx-auto mb-10 mt-10">
          ...
          <ul className="space-y-8">
            <li className="border-l-4 border-red-500 pl-4 bg-white shadow-lg rounded-lg p-5 hover:scale-110 transition duration-300">
              ...
              <p>
                Hotline: <span className="font-medium">+63-2-8911-1406</span>
              </p>
              <p>
            ...
            <li className="border-l-4 border-red-600 pl-4 bg-white shadow-lg rounded-lg p-5 hover:scale-110 transition duration-300">
              ...
              <p>
                Hotline: <span className="font-medium">+63-2-790-2300</span>
              </p>
              <p>
                Emergency Number: <span className="font-medium">143</span>
              </p>
            </li>
          </ul>
        </div>
